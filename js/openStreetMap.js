...
Camel = L.marker([23.16, 7.56]).bindPopup("<h1 class='popup-header'>Camel</h1><br/><img src='img/camel.jpeg' width='300px'/>", clas).addTo(map);

L.DomEvent.addListener(Koala, 'click', function(event){
    // do stuff
}, context);